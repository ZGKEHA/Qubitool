...
def month1():
    ...
    print('\t01st average price:   ' + str(np.mean(month1[0])))
    print('\t02nd average price:   ' + str(np.mean(month1[1])))
    print('\t03rd average price:   ' + str(np.mean(month1[2])))
    print('\t04th average price:   ' + str(np.mean(month1[3])))
    print('\t05th average price:   ' + str(np.mean(month1[4])))
    print('\t06th average price:   ' + str(np.mean(month1[5])))
    print('\t07th average price:   ' + str(np.mean(month1[6])))
    print('\t08th average price:   ' + str(np.mean(month1[7])))
    print('\t09th average price:   ' + str(np.mean(month1[8])))
